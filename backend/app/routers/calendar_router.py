...
async def get_streak(
    ...
    """활동 스트릭 (연속 활동일) 조회."""
    return await calendar_service.get_streak(user_id)
...
async def get_activity_data(
    ...
    """지정 기간의 일별 활동 데이터 조회."""
    activity = await calendar_service.get_activity(user_id, days)
...
async def get_timeline_data(
    ...
    """날짜별 스크랩 그룹 타임라인 조회."""
    return await calendar_service.get_timeline(user_id, page, limit)
